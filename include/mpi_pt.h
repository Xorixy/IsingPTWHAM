...
namespace mpi_pt {
    ...
    void init_Ks();
    void update_Ks(ising::Ising &local_ising, std::vector<int> &world_order);
    ...
    std::vector<double> calculate_new_spacings(const std::vector<double> & old_spacings, const std::vector<int> & n_up, const std::vector<int> & n_down);
}